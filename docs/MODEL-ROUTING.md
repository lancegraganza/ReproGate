...
- `stellar_researcher`: `gpt-5.6-luna`, medium — current docs/ecosystem research.
- `code_mapper`: `gpt-5.6-luna`, medium — read-heavy repository mapping.
- `test_runner`: `gpt-5.6-terra`, medium — noisy builds/tests.
- `contract_reviewer`: `gpt-5.6`, high — high-rigor contract review.
